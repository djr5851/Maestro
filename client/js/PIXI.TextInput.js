// Source: https://github.com/Mwni/PIXI.TextInput/blob/master/dist/PIXI.TextInput.js
...
(function (pkg) {
    ...
    var TextInput = /*#__PURE__*/ function (_PIXI$Container) {
        ...
        function TextInput(styles) {
            ...
            if (styles.box) _this._box_generator = typeof styles.box === 'function' ? styles.box : new DefaultBoxGenerator(styles.box);
